    ...
    <body class="index-page">
        ...
        {{-- Flash Messages --}}
        @if (session('success'))
            <div style="background-color: #d4edda; padding: 10px; color: #155724; border: 1px solid #c3e6cb; margin-bottom: 1rem;">
                {{ session('success') }}
            </div>
        @endif

        @if (session('error'))
            <div style="background-color: #f8d7da; padding: 10px; color: #721c24; border: 1px solid #f5c6cb; margin-bottom: 1rem;">
                {{ session('error') }}
            </div>
        @endif
