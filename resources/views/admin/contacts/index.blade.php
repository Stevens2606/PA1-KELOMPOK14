            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Kontak</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Daftar Kontak</h6>
                </nav>
                                                            ...
                                                            <g transform="translate(1716.000000, 291.000000)">
                                                                <g transform="translate(453.000000, 454.000000)">
                                                                    <path class="color-background"
                                                                        d="M43,10.7482083 L43,3.58333333 C43,1.60354167 41.3964583,0 39.4166667,0 L3.58333333,0 C1.60354167,0 0,3.58333333 L0,10.7482083 L43,10.7482083 Z"
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Daftar Kontak</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="p-3">
                                <a href="{{ route('admin.contacts.create') }}" class="btn bg-gradient-primary">Tambah Kontak Baru</a>
                            </div>
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body pt-sm-3 pt-0">
                    ...
                    <div class="w-100 text-center">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com%2Fproduct%2Fmaterial-dashboard"
                            class="btn btn-dark mb-0 me-2" target="_blank">
