<!-- resources/views/admin/mejas/create.blade.php -->
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Meja</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Tambah Meja</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-info shadow-primary border-radius-lg pt-4 pb-3">
                                <!-- Diubah menjadi bg-gradient-info -->
                                <h6 class="text-white text-capitalize ps-3">Tambah Meja Baru</h6>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <input type="text" class="form-control" name="nomor_meja"
                                                    id="nomor_meja" value="{{ old('nomor_meja') }}" required>
                                            </div>
                                            @error('nomor_meja')
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                <select class="form-control" name="status" id="status" required>
                                                    ...
                                                    <option value="dipesan"
                                                        {{ old('status') == 'dipesan' ? 'selected' : '' }}>Dipesan
                                                    </option>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <a href="{{ route('admin.mejas.index') }}"
                                                class="btn bg-gradient-secondary">Batal</a>
                                            <!-- Diubah menjadi btn-outline-info -->
                                        </div>
                                    </div>
                                </form>
                            </div>
