<!-- resources/views/admin/mejas/index.blade.php -->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Meja</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Daftar Meja</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Daftar Meja</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="p-3">
                                <a href="{{ route('admin.mejas.create') }}" class="btn btn-primary">Tambah Meja Baru</a>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $meja->nomor_meja }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $meja->kapasitas }}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{ $meja->status }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <div class="ms-auto text-end pe-3">
                                                    <a class="btn btn-link text-dark px-3 mb-0"
                                                        href="{{ route('admin.mejas.show', $meja->id) }}"><i
                                                            class="material-icons text-sm me-2"></i>Lihat</a>
                                                    <a class="btn btn-link text-warning px-3 mb-0"
                                                        href="{{ route('admin.mejas.edit', $meja->id) }}"><i
                                                            class="material-icons text-sm me-2"></i>Edit</a>
                                                    <form action="{{ route('admin.mejas.destroy', $meja->id) }}"
                                                        method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-link text-danger text-sm me-0"
                                                            onclick="return confirm('Apakah Anda yakin ingin menghapus meja ini?')"><i
