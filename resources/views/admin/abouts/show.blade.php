<!-- resources/views/admin/abouts/show.blade.php -->
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Detail About Us</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Detail About Us</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Detail About Us</h6>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{ $about->title }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" readonly style="resize: none;">{{ $about->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('admin.abouts.index') }}" class="btn btn-secondary">Kembali ke Daftar</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--   Core JS Files and Configurator   -->
    <!-- (Include Core JS Files and Configurator from your layout) -->
</body>
</html>