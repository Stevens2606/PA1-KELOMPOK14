...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Testimoni</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Daftar Testimoni</h6>
                </nav>
        ...
        <div class="container-fluid py-2">
            ...
            @php
                // Tentukan mode: 'index', 'create', atau 'edit' berdasarkan route saat ini
                $mode = '';
                if (Route::currentRouteName() === 'admin.testimoni.index') {
                    $mode = 'index';
                } elseif (Route::currentRouteName() === 'admin.testimoni.create') {
                    $mode = 'create';
                } elseif (Str::startsWith(Route::currentRouteName(), 'admin.testimoni.edit')) {
                    $mode = 'edit';
                }
            @endphp
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Daftar Testimoni</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <!-- <div class="p-3">
                                    <a href="{{ route('admin.testimoni.create') }}" class="btn bg-gradient-primary">Tambah
                                        Testimoni Baru</a>
                                </div> -->
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    ...
                                                    style="width: 15%;">
                                                    Jumlah Rating</th>
                                                <th class="text-secondary opacity-7" style="width: 25%;">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding: 0.75rem;">
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{ $testimoni->nama }}</h6>
                                                            <p class="text-xs text-secondary mb-0">{{ $testimoni->pekerjaan
                                                                }}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center" style="padding: 0.75rem;">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $testimoni->jenis_kelamin
                                                        }}</p>
                                                </td>
                                                <td style="padding: 0.75rem; text-align: left;">
                                                    <p class="text-xs font-weight-bold mb-0"
                                                        style="word-break: break-word;">{{ $testimoni->isi }}</p>
                                                </td>
                                                <td class="align-middle text-center" style="padding: 0.75rem;">
                                                    <div class="stars">
                                                    ...
                                                    <p class="text-xs font-weight-bold mb-0">{{ $testimoni->rating }}</p>
                                                </td>
            ...
            @elseif($mode === 'create' || $mode === 'edit')
                @php
                    $action = ($mode === 'create') ? route('admin.testimoni.store') : route('admin.testimoni.update', $testimoni->id);
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">{{ ($mode === 'create') ? 'Tambah Testimoni
                                        Baru' : 'Edit Testimoni' }}</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="p-3">
                                    <form action="{{ $action }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ isset($testimoni) ? $testimoni->nama : '' }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="pekerjaan" class="form-label">Pekerjaan</label>
                                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                                value="{{ isset($testimoni) ? $testimoni->pekerjaan : '' }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="jenis_kelamin" name="jenis_kelamin">
                                                <option value="pria" {{ isset($testimoni) && $testimoni->jenis_kelamin ==
                                                    'pria' ? 'selected' : '' }}>Pria</option>
                                                <option value="wanita" {{ isset($testimoni) &&
                                                    $testimoni->jenis_kelamin == 'wanita' ? 'selected' : '' }}>Wanita</option>
                                                <option value="lainnya" {{ isset($testimoni) &&
                                                    $testimoni->jenis_kelamin == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                            </select>
                                        </div>
                                        <!-- Sampai sini -->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="isi" name="isi" rows="3"
                                                required>{{ isset($testimoni) ? $testimoni->isi : '' }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="rating" class="form-label">Rating</label>
                                            <input type="number" class="form-control" id="rating" name="rating"
                                                value="{{ isset($testimoni) ? $testimoni->rating : '' }}" min="1" max="5"
                                                required>
                                        </div>
