...
<head>
    ...
    <style>
        ...
        main {
            ...
            min-height: calc(100vh - 200px);  /* Sesuaikan 200px dengan tinggi header + footer */
        }
        ...
        .footer p,
        .footer a {
            color: #fff;          /* Teks putih di dalam footer */
        }

        .footer .address i,
        .footer .contact i,
        .footer .opening-hours i {
            color: #f44336;    /* Warna merah untuk ikon (sesuaikan) */
        ...
        /* Responsive Grid untuk Footer (opsional) */
        .footer .row {
            display: flex;
            flex-wrap: wrap;
        }
        ...
        .footer .col-lg-3,
        .footer .col-md-6 {
            width: 50%; /* Secara default, 2 kolom pada layar menengah */
            padding: 0 15px;
            margin-bottom: 20px;
        }

        /* Pada layar yang lebih besar, gunakan 4 kolom */
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Galeri</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Daftar Galeri</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="p-3">
                                <a href="{{ route('admin.galeri.create') }}" class="btn bg-gradient-primary">Tambah Galeri Baru</a>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $galeri->id }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $galeri->judul }}</p>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <div class="ms-auto text-end pe-3">
                                                    <a class="btn btn-link text-dark px-3 mb-0" href="{{ route('admin.galeri.show', $galeri->id) }}"><i class="material-icons text-sm me-2">visibility</i>Lihat</a>
                                                    <a class="btn btn-link text-warning px-3 mb-0" href="{{ route('admin.galeri.edit', $galeri->id) }}"><i class="material-icons text-sm me-2">edit</i>Edit</a>
                                                    <form action="{{ route('admin.galeri.destroy', $galeri->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-link text-danger text-sm me-0" onclick="return confirm('Apakah Anda yakin ingin menghapus galeri ini?')"><i class="material-icons text-sm me-2">delete</i>Hapus</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
