...
<head>
    ...
    <style>
        /* Custom CSS untuk tampilan lebih sejuk (sama seperti di index.blade.php) */
        :root {
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Detail Galeri</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Detail Galeri</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Detail Galeri</h6>
                            </div>
                        </div>
                        <div class="card-body px-4 pb-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="text-sm font-weight-bold mb-0">ID:</p>
                                    <p class="text-sm">{{ $galeri->id }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p class="text-sm font-weight-bold mb-0">Judul:</p>
                                    <p class="text-sm">{{ $galeri->judul }}</p>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <p class="text-sm font-weight-bold mb-0">Gambar:</p>
                                    @if($galeri->gambar)
                                        <img src="{{ asset('storage/' . $galeri->gambar) }}" alt="{{ $galeri->judul }}" class="img-fluid border-radius-lg shadow-sm">
                                    @else
                            ...
                            <div class="mt-4">
                                <a href="{{ route('admin.galeri.index') }}" class="btn btn-outline-primary">Kembali ke Daftar Galeri</a>
                                <a href="{{ route('admin.galeri.edit', $galeri->id) }}" class="btn btn-primary">Edit Galeri</a>
                            </div>
                        </div>
                    </div>
                </div>
