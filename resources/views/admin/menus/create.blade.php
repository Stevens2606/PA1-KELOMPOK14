...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76"
        href="{{ asset('admin/admintemplate/img/apple-icon.png') }}">
...
<body class="g-sidenav-show  bg-blue-50">  <!-- Diubah menjadi bg-blue-50 -->
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Menu</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Tambah Menu</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-info shadow-primary border-radius-lg pt-4 pb-3">  <!-- Diubah menjadi bg-gradient-info -->
                                <h6 class="text-white text-capitalize ps-3">Tambah Menu Baru</h6>
                            </div>
                        </div>
                            ...
                            <div class="p-3">
                                <form action="{{ route('admin.menus.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="my-3">  <!-- Dihapus input-group-outline dan input-group -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3">
                                                <select class="form-control" name="kategori" id="kategori"
                                                    ...
                                                    <option value="FOOD"
                                                        {{ old('kategori') == 'FOOD' ? 'selected' : '' }}>
                                                        FOOD</option>
                                                    <option value="DRINKS"
                                                        {{ old('kategori') == 'DRINKS' ? 'selected' : '' }}>
                                                        DRINKS</option>
                                                    <option value="SNACK"
                                                        {{ old('kategori') == 'SNACK' ? 'selected' : '' }}>
                                                        SNACK</option>
                                                    <option value="DIMSUM"
                                                        {{ old('kategori') == 'DIMSUM' ? 'selected' : '' }}>
                                                        DIMSUM</option>
                                                </select>
                                            </div>
                                            @error('kategori')
                                        ...
                                        <div class="col-md-6">
                                            <div class="my-3">   <!-- Dihapus input-group dan input-group-outline -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- Pertahankan bg-gradient-primary, atau ubah jadi bg-gradient-info-->
                                            <a href="{{ route('admin.menus.index') }}"
                                                class="btn bg-gradient-secondary">Batal</a> <!-- Diubah menjadi btn-outline-info -->
                                        </div>
                                    </div>
                                </form>
                            </div>
