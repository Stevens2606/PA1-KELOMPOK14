...
<body>
    ...
    <main id="main">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p>Nikmati hidangan lezat dan kopi berkualitas tinggi dalam suasana yang nyaman dan penuh
                            kehangatan. Jadikan setiap momen berharga di Quality Time.</p>
        ...
        <section id="menu" class="menu py-5">
            <div class="container">
                <h2 class="text-center mb-5 fw-bold" style="color: var(--white-color);">Menu Unggulan Kami</h2>
                <p class="text-center lead mb-5 text-muted" style="color: var(--white-color);">Sempurnakan momen bersantap Anda dengan pilihan menu
                    unggulan yang kami racik dengan penuh dedikasi dan bahan-bahan terbaik.</p>
                ...
                <div class="row">
                    ...
                    @if($count < 3) <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card menu-item h-100 border-0 shadow" style="transition: all 0.3s ease;">
                            <div class="overflow-hidden" style="border-radius: 15px;">
                                <img src="{{ asset('storage/menus/' . $menu->gambar) }}" class="card-img-top"
                                    alt="{{ $menu->nama }}"
        ...
        <section id="testimonials" class="py-5" style="color: var(--white-color);">
            <div class="container">
                <h2 class="text-center mb-5 fw-bold" style="color: var(--white-color);">Kata Mereka Tentang Kami</h2>
                <p class="text-center lead mb-5 text-muted" style="color: var(--white-color);">Simak pengalaman berkesan dari para pelanggan yang telah
                    menikmati momen berharga di Quality Time Cafe & Resto.</p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card testimonial-card h-100 border-0 shadow"
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted flex-grow-1" style="font-style: italic;">"{{
                                    $testimoni->isi }}"</p>
                                <hr>
                                <div class="profile mt-3 d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('assets/img/testimonials/default_avatar.png') }}"
                                        alt="Foto {{ $testimoni->nama }}" class="rounded-circle me-3"
                                        style="width: 50px; height: 50px; object-fit: cover;">
                                    @endif
                                    <div>
